...
if __name__ == '__main__':
    ...
    filter_info = dict()
    filter_info['account'] = '0xa8cb0f55c0577d5920b112422cc80c12dce49e6e'#'0xa8cb0f55c0577d5920b112422cc80c12dce49e6e' #'0x704c900140726f918dd26a6dc009f18b3283afd9'  # 0x2E1F1d826B3C3D4A93468721745998b76cF4bc03
    filter_info['date_from'] = '2024-04-01 00:00:00'  # 2022-05-21 00:00:00 '2021-05-27 00:00:00'
    filter_info['date_end'] = '2024-06-05 23:59:59'  # 2022-12-22 23:59:59 '2022-07-18 23:59:59'

    config['path_report'] = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'report')

    report = IncentiveHelper(config)
    report.report_incentive_account(filter_info)
